;;; ~/.doom.d/themes/doom-gruvbox-dark-hard-theme.el -*- lexical-binding: t; -*-

(require 'doom-themes)

;;
(defgroup doom-gruvbox-dark-hard-theme nil
  "Options for doom-gruvbox-dark-hard."
  :group 'doom-themes)

(defcustom doom-gruvbox-dark-hard-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-gruvbox-dark-hard-theme
  :type 'boolean)

(defcustom doom-gruvbox-dark-hard-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-gruvbox-dark-hard
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg         '("#1d2021" nil       nil))
   (bg-alt      (doom-lighten bg 0.02))
   (accent     '("#3c3836" "#3c3836" "brown"))
   ...
   (selection      accent)
   (builtin        orange)
   (comments       (if doom-gruvbox-dark-hard-brighter-comments magenta fg-light))
   (doc-comments   (if doom-gruvbox-dark-hard-brighter-comments (doom-lighten magenta 0.2) fg-light))
   (constants      yellow)
   (functions      green)
   (keywords       red)
   (methods        green)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-gruvbox-dark-hard-padded-modeline
      (if (integerp doom-gruvbox-dark-hard-padded-modeline)
          doom-gruvbox-dark-hard-padded-modeline
        4)))
...
(
   ...
   ;; org-mode
   (org-level-1 :foreground fg :bold bold :height 1.4)
   (org-level-2 :inherit 'org-level-1 :height 0.8)
   ...
   (org-ellipsis :underline nil :foreground fg-light)
...
;;; doom-gruvbox-dark-hard-theme.el ends here
